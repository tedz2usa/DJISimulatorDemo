...
public class MainActivity extends Activity implements View.OnClickListener {
    ...
    private DroneLayout droneLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout ll = (LinearLayout) findViewById(R.id.droneLayout);
        //ll.setBackground(new BitmapDrawable(bg));
        TextView droneMode = (TextView) findViewById(R.id.droneMode);
        droneLayout = new DroneLayout(this);
        droneLayout.linkModeView(droneMode);
        ll.addView(droneLayout);
